"""
Django settings for webappbot project.
...
SECRET_KEY = 'django-insecure-#mehhn4b+tg_qvpd5mt^+9#q7sey!a33=c@&w@h0n=)0p@j^v#'
...
WSGI_APPLICATION = 'webappbot.wsgi.application'
